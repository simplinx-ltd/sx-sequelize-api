    ...
    getById(attributesExclude) {
        return (req, res, next) => {
            ...
            if (includeFnResult.error) {
                ...
                return next((0, sx_api_error_1.createApiError)(sx_api_error_1.commonErrors.EWRONG_FORMAT, 'Include Format Error'));
            }
            let filter = {
                where: where,
    ...
    getAll(attributesExclude) {
        return (req, res, next) => {
            ...
            if (orderFnResult.error) {
                ...
                return next((0, sx_api_error_1.createApiError)(sx_api_error_1.commonErrors.EWRONG_FORMAT, 'Order Format Error'));
            }
            let filter = {
                where: where,
        ...
        return (req, res, next) => {
            ...
            this.model
                ...
                if (!record) {
                    ...
                    return next((0, sx_api_error_1.createApiError)(sx_api_error_1.commonErrors.ERECORD_NOT_FOUND));
                }
                record
                    .update(req.body)
                    .then((result) => {
